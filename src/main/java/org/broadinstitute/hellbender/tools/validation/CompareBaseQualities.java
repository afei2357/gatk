...
public final class CompareBaseQualities extends PicardCommandLineProgram {
    ...
    private static final String THROW_ON_DIFF_SHORT_NAME = "cd";
    private static final String THROW_ON_DIFF_LONG_NAME = "throw-on-diff";

    private static final String STATIC_QUANTIZED_QUALS_SHORT_NAME = "SQQ";
    private static final String STATIC_QUANTIZED_QUALS_LONG_NAME = "static-quantized-quals";

    private static final String ROUND_DOWN_QUANTIZED_SHORT_NAME = "RDQ";
    private static final String ROUND_DOWN_QUANTIZED_LONG_NAME = "round-down-quantized";
    ...
    @Argument(
            ...
            shortName = THROW_ON_DIFF_SHORT_NAME,
            optional = true
    )
    ...
    @Argument(
            ...
            shortName = STATIC_QUANTIZED_QUALS_SHORT_NAME,
            optional = true
    )
    ...
    @Argument(
            ...
            shortName = ROUND_DOWN_QUANTIZED_SHORT_NAME,
            optional = true
    )
